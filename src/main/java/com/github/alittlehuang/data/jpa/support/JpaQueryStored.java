...
public class JpaQueryStored<T, P> extends AbstractQueryStored<T, P> {
    ...
    public JpaQueryStored(EntityManager entityManager,
                          Class<T> type,
                          PageFactory<T, P> factory) {
        super(factory);
    ...
    private class StoredData<R> {
        ...
        List<R> getPage(Pageable pageable) {
        ...
        <X> Expression toExpression(com.github.alittlehuang.data.query.specification.Expression<X> expression, CriteriaBuilder cb, Root<X> root) {
...
//            int doubleArgs = 2;
        ...
        class SpecificationImpl {
            ...
            SpecificationImpl(WhereClause<T> whereClause) {
