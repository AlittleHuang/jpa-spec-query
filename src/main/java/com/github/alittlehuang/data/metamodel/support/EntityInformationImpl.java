...
public class EntityInformationImpl<T, ID> implements EntityInformation<T, ID> {
    ...
    public static <X, Y> EntityInformationImpl<X, Y> getInstance(Class<X> clazz) {
        Objects.requireNonNull(clazz.getAnnotation(Entity.class), "the class must be an entity");
        //noinspection unchecked
        return (EntityInformationImpl<X, Y>) MAP.computeIfAbsent(clazz, EntityInformationImpl::new);
    }
